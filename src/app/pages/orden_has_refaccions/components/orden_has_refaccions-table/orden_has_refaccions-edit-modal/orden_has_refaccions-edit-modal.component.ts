...
@Component({
  ...
  styleUrls: [('./orden_has_refaccions-edit-modal.component.scss')],
  templateUrl: './orden_has_refaccions-edit-modal.component.html'
})
export class Orden_has_refaccionsEditModalComponent extends DialogComponent<Orden_has_refaccionsInterface, any> implements OnInit, Orden_has_refaccionsInterface {
  _orden: string[] = [];
  _refaccion: string[] = [];
