...
@Component({
  ...
  styleUrls: [('./mantenimientos-edit-modal.component.scss')],
  templateUrl: './mantenimientos-edit-modal.component.html'
})
export class MantenimientosEditModalComponent extends DialogComponent<MantenimientosInterface, any> implements OnInit, MantenimientosInterface {
