...
export class Si_rolsService {
    ...
    constructor(
        ...
        this.endPoint = `${this._configuration.ServerWithApiUrl}si_rol`;
       }
       ...
       update = ( si_rol: Si_rolsInterface ) : Observable<Si_rolsResponseInterface> => {
           return this._http.patch(this.endPoint, si_rol, this.options)
               .map((response: Response) => response.json())
               .catch(this.handleError);
       }
       ...
       insert = ( si_rol: Si_rolsInterface ) : Observable<Si_rolsResponseInterface> => {
           return this._http.post(this.endPoint, si_rol, this.options)
               .map((response: Response) => response.json())
               .catch(this.handleError);
       }
