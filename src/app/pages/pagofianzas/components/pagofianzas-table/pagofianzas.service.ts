...
@Injectable()
export class PagofianzasService {
    ...
    constructor(
       ...
       findById = ( id ) : Observable<PagofianzasResponseInterface> => {
           return this._http.get(`${this.endPoint}/${id}`, this.options)
               .map((response: Response) => response.json())
               .catch(this.handleError);
       }
       update = ( pagofianza: PagofianzasInterface ) : Observable<PagofianzasResponseInterface> => {
           return this._http.patch(this.endPoint, pagofianza, this.options)
               .map((response: Response) => response.json())
               .catch(this.handleError);
       }
       remove= ( id ) : Observable<PagofianzasResponseInterface> => {
           return this._http.delete(`${this.endPoint}/${id}`, this.options)
               .map((response: Response) => response.json())
               .catch(this.handleError);
       }
       exist = ( id ) : Observable<PagofianzasResponseInterface> => {
           return this._http.get(`${this.endPoint}/${id}`, this.options)
               .map((response: Response) => response.json())
               .catch(this.handleError);
       }
       count = () : Observable<PagofianzasResponseInterface> => {
           return this._http.get(`${this.endPoint}`, this.options)
               .map((response: Response) => response.json())
               .catch(this.handleError);
       }
       insert = ( pagofianza: PagofianzasInterface ) : Observable<PagofianzasResponseInterface> => {
           return this._http.post(this.endPoint, pagofianza, this.options)
               .map((response: Response) => response.json())
               .catch(this.handleError);
       }
