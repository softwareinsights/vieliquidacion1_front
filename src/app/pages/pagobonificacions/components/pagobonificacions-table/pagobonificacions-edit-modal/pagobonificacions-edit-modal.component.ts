...
@Component({
  ...
  styleUrls: [('./pagobonificacions-edit-modal.component.scss')],
  templateUrl: './pagobonificacions-edit-modal.component.html'
})
export class PagobonificacionsEditModalComponent extends DialogComponent<PagobonificacionsInterface, any> implements OnInit, PagobonificacionsInterface {
